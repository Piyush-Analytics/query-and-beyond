      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center text-center max-w-lg gap-4 overflow-hidden">
            ...
            <p className="opacity-70 text-[14px] sm:text-[15px] leading-relaxed font-medium">
              Looking for a data analyst or want to discuss a project? Drop a message below and I'll get back to you.
            </p>
          </div>
        ...
        >
          ...
          <p className="text-center md:text-left">
            Developed by <strong className="text-[var(--text-color)]">Piyush Kumar</strong>
          </p>
