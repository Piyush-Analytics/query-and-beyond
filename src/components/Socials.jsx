...
const socials = [
  ...
  {
    name: 'GitHub',
    username: 'Piyush-Analytics',
    url: 'https://github.com/Piyush-Analytics',
...
const Socials = () => {
  return (
    <div className="min-w-screen border-b-2" style={{ borderColor: 'var(--border-color)' }}>
      <div
        className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-[90%] sm:max-w-[85%] md:max-w-[75%] lg:max-w-[60.8%] ml-[5%] sm:ml-[10%] md:ml-[15%] lg:ml-[19.4%] border-l border-r py-4 sm:py-6"
          ...
          >
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="text-sm" style={{ color: 'var(--text-color)', opacity: 0.6 }}>
                  {social.username}
                </div>
              </div>
            </div>
            <ExternalLink className="w-4 h-4" style={{ color: 'var(--icon-color)', opacity: 0.7 }} />
          </a>
        ))}
      </div>
